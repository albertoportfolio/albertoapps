...
// Magic UI — iPhone 15 Pro mockup (https://magicui.design/docs/components/iphone).
// Versión oficial (clases Tailwind). Añadido `children` opcional para renderizar
// una pantalla personalizada dentro del marco, además del `src`/`videoSrc`.
  ...
  return (
    ...
    >
      ...
      {!hasVideo && !src && children && (
        <div className="absolute z-0 overflow-hidden" style={slotStyle}>
          {children}
        </div>
      )}
      ...
      >
        <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
          <path
            ...
            className="fill-[#4a4b55] dark:fill-[#404040]"
          />
          <path
        ...
        <path
          ...
          className="fill-[#4a4b55] stroke-[#4a4b55] stroke-[0.5] dark:fill-[#262626] dark:stroke-[#404040]"
